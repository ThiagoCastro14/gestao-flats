...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>Gestão Flats - Gerente</title>
...
<link rel="icon" href="{{asset('icone/favicon.ico')}}">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Gestão Flats - Gerente</a>
